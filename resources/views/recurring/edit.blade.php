...
@section('title', 'Edit Pengeluaran Berulang - Budget Tracker')
...
<div class="max-w-2xl mx-auto">
    <div class="flex items-center space-x-3 mb-5">
        ...
        <h1 class="text-xl md:text-2xl font-bold text-gray-900 dark:text-white">Edit Pengeluaran Berulang</h1>
    </div>
