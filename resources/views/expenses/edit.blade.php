...
@section('title', __('messages.expenses.edit_expense') . ' - ' . __('messages.app_name'))
...
<div class="max-w-2xl mx-auto">
    <div class="flex items-center space-x-3 mb-5">
        ...
        <h1 class="text-xl md:text-2xl font-bold text-gray-900 dark:text-white">{{ __('messages.expenses.edit_expense') }}</h1>
    </div>
...
<script>
    ...
    function confirmCancel(url) {
        showConfirm({
            type: 'warning',
            title: '{{ __('messages.expenses.edit_cancel_title') }}',
            message: '{{ __('messages.expenses.edit_cancel_message') }}',
