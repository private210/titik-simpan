...
class SecurityHeaders
{
    public function handle(Request $request, Closure $next): Response
    {
        ...
        // ponytail: script/style pakai 'unsafe-inline' — semua inline script view butuh nonce agar bisa drop ini.
        // Upgrade path: berikan nonce ke setiap <script>/<style> blade, lalu ganti ke nonce-only + strict-dynamic.
        $csp = [
            "default-src 'self'",
